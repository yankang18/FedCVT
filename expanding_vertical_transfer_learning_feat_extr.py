...
class RankedRepresentationLearner(object):
    ...
    @staticmethod
    def estimate_lbls_for_host_overlap(Uh_uniq, Uh_overlap_uniq, Uh_comm, Ug_all_comm, Ug_overlap_uniq, Yg_overlap, Yg_all, W_hg=None):
        pass
