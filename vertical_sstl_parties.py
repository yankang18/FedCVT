...
class ExpandingVFTLGuest(ExpandingVFTLParty):
    ...
    def __init__(self, party_model_param: PartyModelParam, data_loader: ExpandingVFTLDataLoader):
        ...
        self.Y_all_in_for_est = tf.compat.v1.placeholder(tf.float32, shape=(None, self.n_class), name="labels_input_all_for_est")
        ...
        self.Y_non_overlap_in = tf.compat.v1.placeholder(tf.float32, shape=(None, self.n_class), name="labels_input_non_overlap")
